 ...
 * @author Dave Syer
 */
public class LifeOAuth2RestTemplate{
//public class LifeOAuth2RestTemplate extends RestTemplate implements OAuth2RestOperations {
//
...
//
//    public LifeOAuth2RestTemplate(OAuth2ProtectedResourceDetails resource) {
//        this(resource, new DefaultOAuth2ClientContext());
//    }
//
//    public LifeOAuth2RestTemplate(OAuth2ProtectedResourceDetails resource, OAuth2ClientContext context) {
//        super();
//        if (resource == null) {
...
//        }
//        logger.debug(">>>>>>>>>>>>>>>uri: " + uri + ", authenticationScheme: " + authenticationScheme.toString() + ", ClientHttpRequest: " + req.toString());
//        return req;
//
//    }
//

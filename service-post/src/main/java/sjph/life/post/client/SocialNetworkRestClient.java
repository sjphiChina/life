 ...
 */
@Component
public class SocialNetworkRestClient {

    private static final Logger LOGGER = LoggerFactory.getLogger(SocialNetworkRestClient.class);
